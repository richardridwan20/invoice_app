                                    ...
                                    <table class="table table-hover table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($invoice->detail as $detail)
                                                <tr>
                                                    <td>{{ $no++ }}</td>
                                                    <td>{{ $detail->product->title }}</td> {{-- Ngambil title nya product dari detail. --}}
                                                    <td>{{ $detail->qty }}</td> {{-- Ngambil quantity dari detail. --}}
                                        ...
                                        {{-- Memilih Produk yang akan ditambahkan. --}}
                                        <tfoot>
                                            <tr>
                                                <td></td>
                                                <td>
                                                    ...
                                                    <select name="product_id" class="form-control">
                                                        ...
                                                        {{-- Buat ngambil data product di database. --}}
